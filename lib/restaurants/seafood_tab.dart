...
class SeafoodTab extends StatefulWidget {
  const SeafoodTab({Key? key}) : super(key: key);

  @override
  State<SeafoodTab> createState() => _SeafoodTabState();
}

class _SeafoodTabState extends State<SeafoodTab> {
  @override
